    ...
    return [
        ...
        // - User CRUD -
        {
            ...
            handler: function (request, reply) {
                ...
                Users.query().findById(request.params.id).omit(['password']).asCallback((userErr, foundUser) => {
        ...
        },
        {
            ...
            handler: (request, reply) => {
                ...
                if (user){
                    Users.query().findById(user.id).omit(['password']).asCallback((userErr, foundUser) => {
        ...
        },
        {
            ...
            handler: (request, reply) => {
                ...
                Users.query().omit(['password']).asCallback((userErr, foundUser) => {
